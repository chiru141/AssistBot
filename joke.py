...
app = Flask(__name__)
PAGE_ACCESS_TOKEN ="EAAEYD3T8JdIBAMj5uzoq2dANzB3dQZBuZBQ3ZAuTwZCX5AOPrxtJOdPsXHbx907ZAixUKfUvwH8KrtWdizZBIAxQ1Dy1DYeagIhd47yJNR9b52V8KfZAZAFtRRN6AiRYKix2h0nWrxZAE9O58N0gAhntyMmNoZArscAEY0Xt65Ij9opwZDZD"
...
all_jokes = {
    'traditional': [
      ...
      'For a period, Houdini used a trap door in every single show he didâ\x80\xa6I guess you could say it was a stage he was going through.',
...
def merge(request):
    ...
    joketype = first_entity_value(entities, 'joketype')
    if joketype:
        context['cat'] = joketype
